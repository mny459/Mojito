...
@AndroidEntryPoint
class TimerNotePickerFragment : BaseVBFragment<FragmentMottoPickerBinding>() {

    private val mViewModel by activityViewModels<TimerNotePickerViewModel>()
    ...
    override fun initView(view: View) {
        ...
        mAdapter.mOnMottoClickedListener = {
            ...
            if (mActivity is TimerNoteConfigurePickerActivity) {
