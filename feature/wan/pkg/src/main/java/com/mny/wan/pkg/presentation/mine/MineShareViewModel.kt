 ...
 */
@HiltViewModel
class MineShareViewModel @Inject constructor(private val mUseCase: ArticleUseCase) :
    BaseArticlePageVM() {
    ...
    override fun initWithCache() {
        super.initWithCache()
        mUseCase.fetchMineShareCacheArticle(mCurPage)
            .onEach {
                onDataLoaded(it)
            }
    ...
    override fun onLoadData() {
        super.onLoadData()
        mUseCase.fetchMineShareArticle(mCurPage)
            .onEach {
                onDataLoaded(it)
            }
            .launchIn(viewModelScope)
