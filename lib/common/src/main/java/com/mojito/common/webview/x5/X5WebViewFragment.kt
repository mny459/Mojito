package com.mojito.common.webview.x5
...
import com.mojito.common.webview.BaseWebViewFragment
 ...
 */
@AndroidEntryPoint
class X5WebViewFragment : BaseWebViewFragment<WebViewFragmentBinding>() {
    ...
    override fun initWebView(view: View) {
        ...
        val webView = X5WebView(mActivity!!)
    ...
    override fun initClient() {
        mWebView?.webViewClient = object : WebViewClient() {
            ...
            private fun shouldOverrideUrlLoading(uri: Uri): Boolean {
                val inWhiteHost = HostInterceptHelper.isWhiteHost(uri.host)
                LogUtils.v("WebView shouldOverrideUrlLoading inWhiteHost = $inWhiteHost uri = $uri ")
                return !inWhiteHost
            }
    ...
    override fun initSettings() {
        mWebView?.settings?.apply {
            ...
            cacheMode = if (NetworkUtils.isConnected()) IX5WebSettings.LOAD_DEFAULT
            else IX5WebSettings.LOAD_CACHE_ELSE_NETWORK
