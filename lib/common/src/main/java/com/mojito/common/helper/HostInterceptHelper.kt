...
object HostInterceptHelper {
   private const val TYPE_NOTHING = 0
   private const val TYPE_ONLY_WHITE = 1
   private const val TYPE_INTERCEPT_BLACK = 2
    ...
    fun isWhiteHost(host: String?): Boolean {
        return WHITE_HOST.contains(host)
    }

    fun isBlackHost(host: String?): Boolean {
        return BLACK_HOST.contains(host)
    }

    private val WHITE_HOST = arrayOf(
        "www.wanandroid.com",
        "study.163.com",
        "juejin.im",
        "juejin.cn",
    ...
    private val BLACK_HOST = arrayOf(
        "www.taobao.com",
        "www.jd.com",
        "yun.tuisnake.com"
    )
